...
class FaqFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $question2->setContent('Quis nostrud exercitation ullamco laboris 
